    ...
    <>
      <div>
        <div className="flex justify-between   h-12">
          <div onClick={() => navigate("/home")} className="ml-4 my-auto">
              ...
              <div className="hidden md:flex">
                <div onClick={() => setOpenRegistration!(true)}>
                  <motion.h2
                    ...
                    className="text-white h-full  cursor-pointer flex items-center gap-2  px-4  text-base  content-center"
                  >
                    Register
                  </motion.h2>
                </div>
                <div onClick={() => setOpenLogin!(true)}>
                  <motion.h2
                    ...
                    className="text-white cursor-pointer  flex items-center gap-2  font- text-base px-4  h-full content-center"
                  >
                    Sign In
                  </motion.h2>
                </div>
