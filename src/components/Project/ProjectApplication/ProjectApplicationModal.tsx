...
import { GetClientProjectRequirement } from "../../../interfaces/projects/client-specific-projects/GetClientProjectModel";
...
export default function ProjectApplicationModal({
  ...
  isOpen: boolean;
  onClose: () => void;
  selectedRequirements: GetClientProjectRequirement[];
  ...
  const { data: requirementTests } = useGetProjectRequirementTestQuery({
    requirementNames: enabledRequirements.map((sr) => sr.requirement.name),
  });
